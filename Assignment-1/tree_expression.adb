package body Tree_Expressio is
        ...
        begin
            for I in Expression_String'Range loop
                if Expression_String [I] = '(' then
                    ...
                    return Gen_Tree.Create_Node ( Expression_String[I], construct ( Expression_String[First .. (I - 1)]), construct ( Expression_String [(I + 1) .. Last]));
